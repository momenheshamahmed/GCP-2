...
export const miningInfrastructure: Infrastructure[] = [
  // Ports
  {
    ...
    descriptionAr: "ميناء صناعي رئيسي يخدم قطاعات التعدين والبتروكيماويات مع مرافق مناولة سائبة متخصصة.",
  ...
  // Railways
  {
    ...
    nameAr: "خط السكك الحديدية السعودي - الخط الشمالي",
    location: {
      latitude: 28.0000,
      longitude: 44.0000,
    ...
    descriptionAr: "خط سكة حديد بطول 2,800 كم يربط مناجم الفوسفات بمرافق المعالجة والتصدير.",
  ...
  },
  {
    ...
    nameAr: "خط القطار السعودي الرابط",
    location: {
      latitude: 25.0000,
      longitude: 45.0000,
      region: "Riyadh",
  ...
  },
  {
    ...
    nameAr: "مجمع الطاقة الشمسية لقطاع التعدين",
    location: {
      latitude: 24.5000,
      longitude: 41.5000,
      region: "Qassim",
  ...
  // Processing Facilities
  {
    ...
    nameAr: "مصهر الألومنيوم برأس الخير",
    location: {
      latitude: 27.4667,
      longitude: 49.2000,
      region: "Eastern Province",
  ...
  },
  {
    ...
    nameAr: "مجمع الأسمدة بوعد الشمال",
    location: {
      latitude: 31.6667,
      longitude: 37.5000,
      region: "Northern Borders",
  ...
  // Roads
  {
    ...
    nameAr: "طريق الممر التعديني السريع",
    location: {
      latitude: 24.0000,
      longitude: 41.0000,
      region: "Madinah",
...
export const waterResources: WaterResource[] = [
  ...
  },
  {
    ...
    nameAr: "إمدادات مياه وعد الشمال",
    capacity: 75000,
    unit: "m³/day",
    location: {
      latitude: 31.6667,
  ...
  },
  {
    ...
    nameAr: "المياه المعاد تدويرها لقطاع التعدين",
    capacity: 50000,
    unit: "m³/day",
    renewable: true,
    quality: "fair",
...
export const investmentMetrics: InvestmentMetric[] = [
  {
    ...
    categoryAr: "إجمالي الاستثمار التعديني",
    value: 125000000000,
    unit: "SAR",
    year: 2024,
  ...
  },
  {
    ...
    categoryAr: "المساهمة في الناتج المحلي",
    value: 97000000000,
    unit: "SAR",
    year: 2024,
    ranking: {
  ...
  },
  {
    ...
    categoryAr: "ترتيب إنتاج الفوسفات",
    value: 6,
    unit: "position",
    year: 2024,
    ranking: {
  ...
  },
  {
    ...
    categoryAr: "ترتيب إنتاج الذهب (العالم العربي)",
    value: 1,
    unit: "position",
    year: 2024,
    ranking: {
